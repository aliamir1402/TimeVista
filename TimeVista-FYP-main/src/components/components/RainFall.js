...
import TempIcon from "../components/images/icons8-rainfall-96.png";
...
export default function RainFall() {
  ...
  const MetricsFunc = (graphData) => {
    ...
    for (let i = 0; i < graphData.length; i++) {
      tempArray.push(graphData[i].total_precipitation_mean * 1000);
      DateArray.push(graphData[i].date);
      dataChart.push({
        x: graphData[i].date,
        y: graphData[i].total_precipitation_mean * 1000,
      });
    }
    dataChart.reverse();
            ...
            </div>
            {
              ...
              >
                <div className="p-2 bgcolor-feature-2 mb-4">
                  <div className="name-box-feature-2 mb-4">Mean RainFall</div>
                  <div className="name-box-feature-description-2">
                    {(metricsObj.avgValue - 273.15 + 273.15).toFixed(1)} mm
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="name-box-feature-description-2">
                    {(metricsObj.minValue - 273.15 + 273.15).toFixed(1)} mm
                  </div>
                ...
                <div className="p-2 bgcolor-feature-1 mb-4">
                  <div className="name-box-feature-1">Maximum RainFall</div>
                  <div className="name-box-feature-description-1">
                    {(metricsObj.maxValue - 273.15 + 273.15).toFixed(1)} mm
                  </div>
        ...
        <div className="flex_item p-4 flex_box">
          ...
          <div className="flex_item">
            <iframe
              ...
              src="https://map.worldweatheronline.com/RainFall"
              frameborder="0"
            ></iframe>
          </div>
          /}
