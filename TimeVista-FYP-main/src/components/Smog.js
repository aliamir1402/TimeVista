...
import SmogIcon from "./images/icons8-co2-cloud-64.png";
  ...
  return (
    <>
      <div className="flex_box">
        <div className="flex_item mb-4">
          <SimpleAreaChart feature="Smog" TempIcon={SmogIcon}></SimpleAreaChart>
        </div>

        <div
          className="flex_item p-6 ml-8 w-fit h-fit div-box-feature"
