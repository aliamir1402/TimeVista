...
import TempIcon from "../components/images/icons8-co2-cloud-64.png";
            ...
            </div>
            {
              ...
              >
                <div className="p-2 bgcolor-feature-2 mb-4">
                  <div className="name-box-feature-2 mb-4">Mean Smog</div>
                  <div className="name-box-feature-description-2">
                    {(metricsObj.avgValue - 273.15 + 273.15).toFixed(1)}M ppm
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="name-box-feature-description-2">
                    {(metricsObj.minValue - 273.15 + 273.15).toFixed(1)}M ppm
                  </div>
                ...
                <div className="p-2 bgcolor-feature-1 mb-4">
                  <div className="name-box-feature-1">Maximum Smog</div>
                  <div className="name-box-feature-description-1">
                    {(metricsObj.maxValue - 273.15 + 273.15).toFixed(1)}M ppm
                  </div>
        ...
        <div className="flex_item p-4 flex_box">
          ...
          <div className="flex_item">
            <iframe
              ...
              src="https://map.worldweatheronline.com/Smog"
              frameborder="0"
            ></iframe>
          </div>
          /}
